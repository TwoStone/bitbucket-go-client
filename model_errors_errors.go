...
func (o ErrorsErrors) MarshalJSON() ([]byte, error) {
...
type NullableErrorsErrors struct {
	value *ErrorsErrors
	isSet bool
}

func (v NullableErrorsErrors) Get() *ErrorsErrors {
	return v.value
}

func (v *NullableErrorsErrors) Set(val *ErrorsErrors) {
	v.value = val
	v.isSet = true
}

func (v NullableErrorsErrors) IsSet() bool {
	return v.isSet
}

func (v *NullableErrorsErrors) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableErrorsErrors(val *ErrorsErrors) *NullableErrorsErrors {
	return &NullableErrorsErrors{value: val, isSet: true}
}

func (v NullableErrorsErrors) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableErrorsErrors) UnmarshalJSON(src []byte) error {
	v.isSet = true
