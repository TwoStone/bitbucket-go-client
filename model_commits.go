...
func (o Commits) MarshalJSON() ([]byte, error) {
...
type NullableCommits struct {
	value *Commits
	isSet bool
}

func (v NullableCommits) Get() *Commits {
	return v.value
}

func (v *NullableCommits) Set(val *Commits) {
	v.value = val
	v.isSet = true
}

func (v NullableCommits) IsSet() bool {
	return v.isSet
}

func (v *NullableCommits) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableCommits(val *Commits) *NullableCommits {
	return &NullableCommits{value: val, isSet: true}
}

func (v NullableCommits) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableCommits) UnmarshalJSON(src []byte) error {
	v.isSet = true
