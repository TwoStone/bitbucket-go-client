...
// BuildResult struct for BuildResult
...
type NullableBuildResult struct {
	value *BuildResult
	isSet bool
}

func (v NullableBuildResult) Get() *BuildResult {
	return v.value
}

func (v *NullableBuildResult) Set(val *BuildResult) {
	v.value = val
	v.isSet = true
}

func (v NullableBuildResult) IsSet() bool {
	return v.isSet
}

func (v *NullableBuildResult) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableBuildResult(val *BuildResult) *NullableBuildResult {
	return &NullableBuildResult{value: val, isSet: true}
}

func (v NullableBuildResult) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableBuildResult) UnmarshalJSON(src []byte) error {
	v.isSet = true
