...
// GetCommiter returns the Commiter field value
...
// GetCommiterOk returns a tuple with the Commiter field value
// and a boolean to check if the value has been set.
...
func (o *Commit) GetCommiterTimestampOk() (*string, bool) {
	...
	return &o.CommiterTimestamp, true
}
...
// SetParents gets a reference to the given []CommitParents and assigns it to the Parents field.
...
func (o Commit) MarshalJSON() ([]byte, error) {
	...
	if true {
		toSerialize["commiterTimestamp"] = o.CommiterTimestamp
	}
	if true {
