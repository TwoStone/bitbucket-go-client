...
type NullableBranchesAllOf struct {
	value *BranchesAllOf
	isSet bool
}

func (v NullableBranchesAllOf) Get() *BranchesAllOf {
	return v.value
}

func (v *NullableBranchesAllOf) Set(val *BranchesAllOf) {
	v.value = val
	v.isSet = true
}

func (v NullableBranchesAllOf) IsSet() bool {
	return v.isSet
}

func (v *NullableBranchesAllOf) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableBranchesAllOf(val *BranchesAllOf) *NullableBranchesAllOf {
	return &NullableBranchesAllOf{value: val, isSet: true}
}

func (v NullableBranchesAllOf) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableBranchesAllOf) UnmarshalJSON(src []byte) error {
	v.isSet = true
