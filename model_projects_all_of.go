...
// ProjectsAllOf struct for ProjectsAllOf
type ProjectsAllOf struct {
...
func (o ProjectsAllOf) MarshalJSON() ([]byte, error) {
...
type NullableProjectsAllOf struct {
	value *ProjectsAllOf
	isSet bool
}

func (v NullableProjectsAllOf) Get() *ProjectsAllOf {
	return v.value
}

func (v *NullableProjectsAllOf) Set(val *ProjectsAllOf) {
	v.value = val
	v.isSet = true
}

func (v NullableProjectsAllOf) IsSet() bool {
	return v.isSet
}

func (v *NullableProjectsAllOf) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableProjectsAllOf(val *ProjectsAllOf) *NullableProjectsAllOf {
	return &NullableProjectsAllOf{value: val, isSet: true}
}

func (v NullableProjectsAllOf) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableProjectsAllOf) UnmarshalJSON(src []byte) error {
	v.isSet = true
