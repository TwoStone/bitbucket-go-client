...
// CommitsAllOf struct for CommitsAllOf
type CommitsAllOf struct {
...
func (o CommitsAllOf) MarshalJSON() ([]byte, error) {
...
type NullableCommitsAllOf struct {
	value *CommitsAllOf
	isSet bool
}

func (v NullableCommitsAllOf) Get() *CommitsAllOf {
	return v.value
}

func (v *NullableCommitsAllOf) Set(val *CommitsAllOf) {
	v.value = val
	v.isSet = true
}

func (v NullableCommitsAllOf) IsSet() bool {
	return v.isSet
}

func (v *NullableCommitsAllOf) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableCommitsAllOf(val *CommitsAllOf) *NullableCommitsAllOf {
	return &NullableCommitsAllOf{value: val, isSet: true}
}

func (v NullableCommitsAllOf) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableCommitsAllOf) UnmarshalJSON(src []byte) error {
	v.isSet = true
