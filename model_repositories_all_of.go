...
// RepositoriesAllOf struct for RepositoriesAllOf
type RepositoriesAllOf struct {
	Values []Repository `json:"values"`
}

// NewRepositoriesAllOf instantiates a new RepositoriesAllOf object
...
// NewRepositoriesAllOfWithDefaults instantiates a new RepositoriesAllOf object
// This constructor will only assign default values to properties that have it defined,
// but it doesn't guarantee that properties required by API are set
func NewRepositoriesAllOfWithDefaults() *RepositoriesAllOf {
	this := RepositoriesAllOf{}
	return &this
}
...
func (o *RepositoriesAllOf) SetValues(v []Repository) {
	o.Values = v
}

func (o RepositoriesAllOf) MarshalJSON() ([]byte, error) {
...
type NullableRepositoriesAllOf struct {
	value *RepositoriesAllOf
	isSet bool
}

func (v NullableRepositoriesAllOf) Get() *RepositoriesAllOf {
	return v.value
}

func (v *NullableRepositoriesAllOf) Set(val *RepositoriesAllOf) {
	v.value = val
	v.isSet = true
}

func (v NullableRepositoriesAllOf) IsSet() bool {
	return v.isSet
}

func (v *NullableRepositoriesAllOf) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableRepositoriesAllOf(val *RepositoriesAllOf) *NullableRepositoriesAllOf {
	return &NullableRepositoriesAllOf{value: val, isSet: true}
}

func (v NullableRepositoriesAllOf) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableRepositoriesAllOf) UnmarshalJSON(src []byte) error {
	v.isSet = true
