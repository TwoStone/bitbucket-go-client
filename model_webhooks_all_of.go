...
// WebhooksAllOf struct for WebhooksAllOf
type WebhooksAllOf struct {
...
func (o WebhooksAllOf) MarshalJSON() ([]byte, error) {
...
type NullableWebhooksAllOf struct {
	value *WebhooksAllOf
	isSet bool
}

func (v NullableWebhooksAllOf) Get() *WebhooksAllOf {
	return v.value
}

func (v *NullableWebhooksAllOf) Set(val *WebhooksAllOf) {
	v.value = val
	v.isSet = true
}

func (v NullableWebhooksAllOf) IsSet() bool {
	return v.isSet
}

func (v *NullableWebhooksAllOf) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableWebhooksAllOf(val *WebhooksAllOf) *NullableWebhooksAllOf {
	return &NullableWebhooksAllOf{value: val, isSet: true}
}

func (v NullableWebhooksAllOf) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableWebhooksAllOf) UnmarshalJSON(src []byte) error {
	v.isSet = true
